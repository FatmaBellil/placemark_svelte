...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })} <div class="columns"><div class="column"><div class="box"><h1 class="title" data-svelte-h="svelte-3ek1ot">Sign up</h1> ${validate_component(SignupForm, "SignupForm").$$render($$result, {}, {}, {})}</div></div> <div class="column has-text-centered" data-svelte-h="svelte-1h3f3an"><img alt="joinus" src="/joinus.png" width="300"></div></div>`;
});
export {
  Page as default
};
