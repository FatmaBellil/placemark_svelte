...
const Base$1 = Base;
const PlacemarksByCategory = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { chartType = "" } = $$props;
  let totalByCategory = { labels: [], datasets: [{ values: [] }] };
  if ($$props.chartType === void 0 && $$bindings.chartType && chartType !== void 0)
    $$bindings.chartType(chartType);
  return `${validate_component(Base$1, "Chart").$$render($$result, { data: totalByCategory, type: chartType }, {}, {})}`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })} <h1 class="title is-4 has-text-centered" data-svelte-h="svelte-1ss9bj9">PLacemarks by Category Chart:</h1> <div class="columns box"><div class="column has-text-centered">${validate_component(PlacemarksByCategory, "PlacemarksByCategory").$$render($$result, { chartType: "bar" }, {}, {})}</div> <div class="column has-text-centered">${validate_component(PlacemarksByCategory, "PlacemarksByCategory").$$render($$result, { chartType: "pie" }, {}, {})}</div></div>`;
});
export {
  Page as default
};
